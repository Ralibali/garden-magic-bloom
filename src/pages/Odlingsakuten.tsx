...
import SaveProblemCta from '@/components/SaveProblemCta';
...
export default function Odlingsakuten() {
  ...
  }), [plant, problem, place, moist, cold, diagnosis]);
