...
const Beds = () => {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (bed) => {
      ...
      toast({ title: 'Odlingsplats skapad! 🌱' });
    },
    onError: (error: any) => {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: (_, id) => {
      ...
      toast({ title: 'Odlingsplats borttagen' });
    },
    onError: (error: any) => toast({ title: 'Kunde inte ta bort odlingsplatsen', description: error?.message, variant: 'destructive' }),
  });
