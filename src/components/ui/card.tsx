...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[1.35rem] border border-border/70 bg-card/95 text-card-foreground shadow-[var(--card-shadow)] backdrop-blur-sm transition-[box-shadow,transform,border-color] duration-300",
      className,
    )}
    {...props}
  />
