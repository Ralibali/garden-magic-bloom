...
const stockImages = [
  { path: '/blog-images/odla-tomater.jpg', label: 'Tomater' },
  { path: '/blog-images/odla-gurka.jpg', label: 'Gurka' },
  { path: '/blog-images/odla-morotter.jpg', label: 'Morötter' },
  { path: '/blog-images/odla-potatis.jpg', label: 'Potatis' },
  { path: '/blog-images/odla-jordgubbar.jpg', label: 'Jordgubbar' },
  { path: '/blog-images/odla-basilika.jpg', label: 'Basilika' },
  { path: '/blog-images/odla-chili.jpg', label: 'Chili' },
  { path: '/blog-images/odla-pumpa.jpg', label: 'Pumpa' },
  { path: '/blog-images/odla-squash.jpg', label: 'Squash' },
  { path: '/blog-images/odla-rabarber.jpg', label: 'Rabarber' },
  { path: '/blog-images/odla-sparris.jpg', label: 'Sparris' },
  { path: '/blog-images/odla-vitlok.jpg', label: 'Vitlök' },
  { path: '/blog-images/odla-kryddor.jpg', label: 'Kryddor' },
  { path: '/blog-images/odla-pallkrage.jpg', label: 'Pallkrage' },
  { path: '/blog-images/odla-balkong.jpg', label: 'Balkongodling' },
  { path: '/blog-images/odla-vaxthus.jpg', label: 'Växthus' },
  { path: '/blog-images/odla-vinter.jpg', label: 'Vinterodling' },
  { path: '/blog-images/odla-groddar.jpg', label: 'Groddar' },
  { path: '/blog-images/odla-svamp.jpg', label: 'Svamp' },
  { path: '/blog-images/odla-gronsaker.jpg', label: 'Grönsaker' },
  { path: '/blog-images/odla-tomater-fro.jpg', label: 'Tomater från frö' },
  { path: '/blog-images/odla-tomater-kruka.jpg', label: 'Tomater i kruka' },
  { path: '/blog-images/kompostera-hemma.jpg', label: 'Kompostering' },
  { path: '/blog-images/spring-garden.jpg', label: 'Vårträdgård' },
  { path: '/blog-images/morning-farm.jpg', label: 'Morgon i trädgården' },
